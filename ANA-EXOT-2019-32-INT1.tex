...
\usepackage{rotating}
\usepackage{todonotes} % Add '[disable]' option to mask them
\usepackage{xcolor}
\usepackage{verbatim}
%-------------------------------------------------------------------------------
...
\input{ANA-EXOT-2019-32-INT1-metadata}
...
%\label{sec:intro}.  % uncomment if label used. 
\input{include/01-introduction.tex}
\clearpage
%-------------------------------------------------------------------------------

%-------------------------------------------------------------------------------
\section{Executive Summary}
%\label{sec:executive}.  % uncomment if label used. 
\input{include/00-executive.tex}
\clearpage
%-------------------------------------------------------------------------------
...
\input{include/02-benchmark_signals.tex}
\clearpage
%-------------------------------------------------------------------------------

\section{Event selection}
\label{sec:event_selection}
\input{include/03-event_selection.tex}
\clearpage
...
\input{include/04-QGselection.tex}
\clearpage
%-------------------------------------------------------------------------------

\section{Sample Optimisation}
%\label{sec:Optimisation} % uncomment if label used. 
\input{include/05-Optimisation.tex}
\clearpage



\section{Statistical Framework}
%\label{sec:statistical_framework} % uncomment if label used. 

\input{include/06-StatisticalFramework.tex}

%\section{Background Estimation Strategy}
%\label{sec:background_estimation}
%\input{include/04-BackgroundEstimation.tex}
%\clearpage

%\section{Search Strategy}
%\label{sec:search_strategy}
%\input{include/06-SearchStrategy.tex}
%\clearpage
%
% %-------------------------------------------------------------------------------
% %%SYSTEMATICS
...
%\label{sec:systematic_uncertainties} % uncomment if label used. 
%\input{texinclude/07-SystematicUncertainties.tex}
\input{include/systematics.tex}
%%-------------------------------------------------------------------------------
%
\clearpage
%
...
%\label{sec:limits}
\input{include/08-LimitTechniques.tex}
\clearpage


%-------------------------------------------------------------------------------
\section{``Quark-Gluon'' Resonance Search Sensitivity}
%\label{sec:QGsensitivity} % uncomment if label used. 
\input{include/QGsensitivity.tex}
%\clearpage
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\section{Conclusion}
%\label{sec:conclusion} % uncomment if label used. 
%-------------------------------------------------------------------------------
