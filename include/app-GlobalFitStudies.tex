...
\begin{figure}
  ...
  \begin{subfigure}{0.8\linewidth}
    \centering
    \includegraphics[width=1\linewidth,height=7cm]{figures/app-GlobalFitStudies/5ParamSwiftYStar0p8_BumpHunterSignifcance.pdf}
    \caption{SWiFt background fit}
    \label{fig:sub1ystar0.8FullRunBHFits}
  \end{subfigure}%
  \begin{subfigure}{0.8\linewidth}
    \centering
    \includegraphics[trim=35 2 10 30, clip,width=1.1\linewidth,height=7cm]{figures/app-GlobalFitStudies/5ParamGlobalYStar0p8_BumpHunterSignifcance.pdf}
...
\begin{figure}
  ...
  \begin{subfigure}{0.8\linewidth}
    \centering
    \includegraphics[trim=0 0 0 20, clip,width=1.0\linewidth,height=6cm]{figures/app-GlobalFitStudies/5ParamSwiftYStar0p8_BumpHunterPValue.pdf}
    \label{fig:sub1ystar0.8FullRunBHPvalue}
  \end{subfigure}%
  \begin{subfigure}{0.8\linewidth}
    \centering
    \includegraphics[trim=10 2 35 35, clip,width=1.0\linewidth,height=6cm]{figures/app-GlobalFitStudies/5ParamGlobalYStar0p8_BumpHunterPValue.pdf}
    \caption{Global background fit}
