...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 1.6cm 1cm},clip,width=1.0\linewidth]{figures/app-GlobalFitStabilityinjectionFitStabilityStringScale7500.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 1.6cm 1cm},clip,width=1.0\linewidth]{figures/app-GlobalFitStabilityinjectionFitStabilityStringScale8000.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 1.6cm 1cm},clip,width=1.0\linewidth]{figures/app-GlobalFitStabilityinjectionFitStabilityStringScale8500.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 1.6cm 1cm},clip,width=1.0\linewidth]{figures/app-GlobalFitStabilityinjectionFitStabilityStringScale9000.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 2cm 1cm},clip,width=1.0\linewidth]{figures/app-GlobalFitStabilityspuriousSignalFitStabilityWidth100.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 2cm 1cm},clip,width=1.0\linewidth]{figures/app-GlobalFitStabilityspuriousSignalFitStabilityWidth1000.pdf}
