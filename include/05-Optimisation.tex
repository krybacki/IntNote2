...
calculated and only those bins are used to calculate the significance. %, not the entire \mjj\ distribution.
...
\begin{tabular}{SSSS}
\toprule
\multicolumn{1}{c}{String Mass (\TeV) } & \multicolumn{3}{c}{Optimal Selection} \\
