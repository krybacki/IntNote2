...
\todo[inline]{Are we going to use NLO k-factors. If not remove this bit}
...
\todo[inline]{Need H$^\prime$ write up}

\subsubsection{Excited quarks}
\label{sec:qstar}

\todo[inline]{If doing comparison limits will we use \qstar\ }
