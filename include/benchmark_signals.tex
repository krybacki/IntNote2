...
\begin{figure}[!htb]
  \centering
  \subfigure[Cross section]{   \label{fig:wprime_xsec} \includegraphics[width=0.48\textwidth]{figures/benchmark_signals/CrossSections_WPrime_log}}
  \subfigure[Acceptance]{ \includegraphics[width=0.48\textwidth]{figures/benchmark_signals/Acceptances_WPrime} }
  \subfigure[Truth Mass]{ \includegraphics[width=0.55\textwidth]{figures/benchmark_signals/Wprime/mWp_normalized.pdf} }
...
\begin{figure}[!htb]
  \centering
  \subfigure[Cross section]{\label{fig:Wstar_xsec}\includegraphics[width=0.48\textwidth]{figures/Wstar/CrossAcceptance/WstarX0_XS.pdf}}
  \subfigure[Acceptance]{\label{fig:Wstar_acc}\includegraphics[width=0.48\textwidth]{figures/Wstar/CrossAcceptance/WstarX0_Acc.pdf}}
	\caption{(a) Cross section and (b) acceptance for the 
